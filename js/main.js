...
const SUPABASE_URL = 'TUS_DATOS_DE_SUPABASE_URL'; // Reemplaza con tu URL de Supabase
const SUPABASE_ANON_KEY = 'TUS_DATOS_DE_SUPABASE_KEY'; // Reemplaza con tu Key anónima
